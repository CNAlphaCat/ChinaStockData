package cn.alphacat.chinastockdata.feature;
...
public class FeatureService {
  public List<FeatureMarketOverview> getFuturesBaseInfo() {
    ...
    System.out.println("total:" + total + ", pz:" + pz + ", pages:" + pages);
    ...
    try (ExecutorService executor =
      ...
      try {
        ...
        List<FeatureMarketOverview> allData = new ArrayList<>();
        for (Future<JsonNode> future : futures) {
          ...
          for (JsonNode item : diffNode) {
            FeatureMarketOverview featureMarketOverview = new FeatureMarketOverview(item);
            allData.add(featureMarketOverview);
          }
        }
        return allData;
